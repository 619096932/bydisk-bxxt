...
$local_user = $rows_user_check['userid'];
include('conn.php');
?>
		...
		<div class="menu-scroll">
			<div class="menu-content">
				...
				<ul class="nav">
					...
					<li>
						<a class="waves-attach waves-effect" href="ui-mtable.php">管理员的订单</a>
					</li>
					<li>
	...
	<main class="content">
		...
		<div class="container">
			<section class="content-inner margin-top-no">
				...
				<?php
				$stmt_user_data=$conn->prepare("SELECT * from avada ORDER BY DATATIME DESC");
