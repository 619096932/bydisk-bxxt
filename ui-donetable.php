...
<head>
	...
	<title>您完成的订单 - 报修平台Ver3.0.3</title>
	...
	<main class="content">
		...
		<div class="container">
			<section class="content-inner margin-top-no">
					...
					<div class="card-main">
						<div class="card-inner">
							...
							<ul>
								...
								<li>RUN = 已有人接单</li>
								<li>DONE = 已完成订单</li>
								<li>WOR-RUN = 正在流程的举报订单</li>
								<li>WOR-DONE = 已完成的举报订单</li>
							</ul>
							<p>请善用Ctrl+F搜索功能</p>
						</div>
					</div>
				...
				<?php
				$stmt_user_data=$conn->prepare("SELECT * from avada where Personnel=? and NOW='已完成' ORDER BY DoneTIME DESC");
