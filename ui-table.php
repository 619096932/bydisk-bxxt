...
<head>
	...
	<title>等待处理的 - 报修平台Ver3.0.3</title>
...
<body class="page-brand">
	...
	<main id="main" class="content">
		<div class="content-heading">
			<div class="container">
				<h1 class="heading">等待处理订单</h1>
			</div>
		</div>
		<div id="container" class="container">
			<section class="content-inner margin-top-no" id="section">
				<div class="card">
					<div class="card-main">
				...
				<?php
				$stmt_user_data=$conn->prepare("SELECT * from avada where NOW='暂无人处理' ORDER BY DATATIME DESC");
				//$stmt_user_data->bind_param();
						...
						<thead>
							...
							<th>
								<div class="card-action-btn pull-left" style="margin: 0;">
									<a class="btn btn-brand-accent btn-flat waves-attach waves-button waves-effect" data-backdrop="static" style="display: initial;" data-toggle="modal" href="#confirm_'.$row[PHONE].'">接单</a>
									<a class="btn btn-brand-accent btn-flat waves-attach waves-button waves-effect" data-backdrop="static" style="display: initial;" data-toggle="modal" href="#wor_'.$row[PHONE].'">举报</a>
									<a class="btn btn-brand-accent btn-flat waves-attach waves-button waves-effect" data-backdrop="static" style="display: initial;" data-toggle="modal" href="#regtop_'.$row[PHONE].'">提交管理员</a>
								</div>
							</th>
							</tr>
						</thead>
	...
	while($row2 = mysqli_fetch_array($result_user_data))
		echo '
	<div aria-hidden="true" class="modal fade" id="confirm_'.$row2['PHONE'].'" role="dialog" tabindex="-1">
		 <div class="modal-dialog modal-xs">
	        <div class="modal-content">
	            <div class="modal-heading"> 接单 </div>
	            <div class="modal-inner"> 接单后30分钟内可取消订单 </div>
	            <div class="modal-footer">
	            	<p class="text-right">
	            		<a class="btn btn-flat btn-brand waves-attach waves-button waves-effect" href="engine.php?action=add&key='.$row2['DATATIME'].'&id='.$username.'">确认接单</a>
	...
	<div aria-hidden="true" class="modal fade" id="regtop_'.$row2['PHONE'].'" role="dialog" tabindex="-1">
		 <div class="modal-dialog modal-xs">
	        <div class="modal-content">
	            <div class="modal-heading"> 提交管理员处理 </div>
	            <div class="modal-inner"> 提交后将进入管理员处理流程 </div>
	            <div class="modal-footer">
	            	<p class="text-right">
	            		<a class="btn btn-flat btn-brand waves-attach waves-button waves-effect" href="engine.php?action=regtop&key='.$row2['DATATIME'].'&id='.$username.'">确认提交</a>
	            		<a class="btn btn-flat btn-brand waves-attach waves-button waves-effect" data-dismiss="modal">取消</a>
	            	</p>
	            </div>
	        </div>
	...
	<div aria-hidden="true" class="modal fade" id="wor_'.$row2['PHONE'].'" role="dialog" tabindex="-1">
	    <div class="modal-dialog modal-xs">
	        <div class="modal-content">
	            <div class="modal-heading"> 举报 </div>
	            <div class="modal-inner"> 举报后查实将列入黑名单 </div>
	            <div class="modal-footer"> 
	            	<p class="text-right">
	            		<a class="btn btn-flat btn-brand waves-attach waves-button waves-effect" href="engine.php?action=wor-add&key='.$row2['DATATIME'].'&id='.$username.'">举报订单</a>
	            		<a class="btn btn-flat btn-brand waves-attach waves-button waves-effect" data-dismiss="modal">取消</a>
	            	</p>
	            </div>
	        </div>
